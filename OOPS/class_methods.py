class Employee:
    ...
    @classmethod
    def show_grades(cls): # here we are not passing self, if we decorated with @classmethod and pass cls , then it is class level method
...
employee_1 = Employee('fName', 'lName', 'A')
